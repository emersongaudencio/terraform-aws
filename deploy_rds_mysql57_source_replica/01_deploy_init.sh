...
echo 'resource "aws_db_parameter_group" "mysql-57-prod-source01" {
  name   = "mysql-57-prod-source01"
  family = "mysql5.7"
...
echo 'resource "aws_db_parameter_group" "mysql-57-prod-replica01" {
  name   = "mysql-57-prod-replica01"
  family = "mysql5.7"
