...
echo 'resource "aws_security_group" "sg-prod-instance-mariadb" {
  vpc_id      = var.VPC_ID
  name        = "sg-prod-instance-mariadb"
  description = "sg-prod-instance-mariadb"
  ingress {
    from_port       = 3306
    to_port         = 3306
    protocol        = "tcp"
...
echo 'resource "aws_db_parameter_group" "prod-instance-mariadb103" {
  name   = "prod-instance-mariadb103"
  family = "mariadb10.3"
...
' > rds_mariadb_parameter_group.tf
