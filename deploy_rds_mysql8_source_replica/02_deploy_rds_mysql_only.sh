...
module "source01" {
  ...
  identifier = "mysql-8-prod-source01"
  ...
  monitoring_role_name = "RDSMySQL8MonitoringRoleSource01"

  parameter_group_name   = "mysql-8-prod-source01" # must already exist in AWS
...
module "replica01" {
  ...
  identifier = "mysql-8-prod-replica01"
  ...
  create_monitoring_role                = true
  monitoring_interval                   = 60
  monitoring_role_name = "RDSMySQL8MonitoringRoleRepl01"

  parameter_group_name   = "mysql-8-prod-replica01" # must already exist in AWS
