...
echo 'resource "aws_security_group" "sg-prod-instance-mysql-8" {
  vpc_id      = var.VPC_ID
...
echo 'resource "aws_db_parameter_group" "mysql-8-prod-source01" {
  name   = "mysql-8-prod-source01"
  family = "mysql8.0"
...
' > rds_mysql_source_parameter_group.tf

echo 'resource "aws_db_parameter_group" "mysql-8-prod-replica01" {
  name   = "mysql-8-prod-replica01"
  family = "mysql8.0"
...
' > rds_mysql_replica_parameter_group.tf
