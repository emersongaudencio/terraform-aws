...
module "rds" {
  ...
  vpc_security_group_ids = [aws_security_group.sg-prod-instance-pg-11.id]
  ...
  monitoring_role_name = "RDSPG11MonitoringRole"

  parameter_group_name   = "prod-instance-pg-11" # must already exist in AWS
